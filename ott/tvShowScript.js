...
// ----------------- CAROUSEL CREATION -----------------
  ...
  createCarousel("tvContent", tvData, "tvCarousel1");
  createCarousel("tvContent1", tvData1, "tvCarousel2");
  createCarousel("tvContent2", tvData2, "tvCarousel3");
  createCarousel("tvContent3", tvData3, "tvCarousel4");
  createCarousel("tvContent4", tvData, "tvCarousel5");
  createCarousel("tvContent5", tvData2, "tvCarousel6");

// modal handling 
const allCards = [...tvData, ...tvData1, ...tvData2, ...tvData3];

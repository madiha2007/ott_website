...
const movieData = [
  ...
  createCarousel("moviecarouselContent", movieData, "moviecarousel1");
  createCarousel("moviecarouselContent1", movieData1, "moviecarousel2");
  createCarousel("moviecarouselContent2", movieData2, "moviecarousel3");
  createCarousel("moviecarouselContent3", movieData3, "moviecarousel4");
  createCarousel("moviecarouselContent4", movieData, "moviecarousel5");
  createCarousel("moviecarouselContent5", movieData2, "moviecarousel6");
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    document.addEventListener("click", function (e) {
      const movie = e.target.closest(".card-modal-trigger");
      if (!movie) return;
      ...
      selectedmovieData = { id, title, img, genre, description };
  
      document.getElementById("movieTitle").textContent = title;
      document.getElementById("movieLabel").textContent = movie.dataset.title;
      ...
      const contentDiv = document.getElementById("movieExtraContent");
    ...
    document.addEventListener("click", function (e) {
      if (e.target.matches("#addToListBtn")) {
        if (selectedmovieData) {
          ...
          if (!myList.find(item => item.id === selectedmovieData.id)) {
            myList.push(selectedmovieData);
